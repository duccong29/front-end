...
const AddApartmentPage: React.FC = () => {
        ...
        action: (
          <div className="flex gap-2 mt-2">
            <Button
              ...
              onClick={() => {
                router.push("/poster/apartments/add")
            ...
            <Button 
              ...
              onClick={() => router.push("/poster/apartments")
              }
              >
              Go to Apartments
            </Button>
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-blue-100 to-white rounded-xl">
      <div className="container px-4 md:px-8 py-8">
      <div className="mb-4">
          <Link
            href="/poster/apartments"
